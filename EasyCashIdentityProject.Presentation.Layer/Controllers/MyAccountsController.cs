...
namespace EasyCashIdentityProject.Presentation.Layer.Controllers
{
    ...
    public class MyAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            appUserEditDto.ImageUrl = values.ImgUrl;
        ...
        {
            if (appUserEditDto.ConfirmPassword == appUserEditDto.ConfirmPassword)
            {
                ...
                user.PasswordHash = _userManager.PasswordHasher.HashPassword(user, appUserEditDto.ConfirmPassword);
