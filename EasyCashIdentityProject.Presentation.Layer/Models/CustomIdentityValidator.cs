...
namespace EasyCashIdentityProject.Presentation.Layer.Models
{
    public class CustomIdentityValidator : IdentityErrorDescriber
    {
        public override IdentityError PasswordTooShort(int length)
        {
            return new IdentityError()
            {
                ...
                Description = $"Parola en az {length} karakter olmalıdır.En:Password must be at least {length} characters"
